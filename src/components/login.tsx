  ...
  return (
    <div className="flex min-h-screen">
      <div className="w-1/2 p-8">
        <img src="/assets/TaskBuddy.png" alt="Hi Buddy" className="h-20 w-50" />
        ...
        <div className="mt-8" onClick={googleLogin}>
          <img src="/assets/g-logo.png" alt="logo" className="ml-4" />
        </div>
      </div>
      <div className="w-1/2 bg-gray-50">
        <img src="/assets/img-login.png" alt="login" className="w-full h-full object-cover" />
      </div>
    </div>
  )
}
